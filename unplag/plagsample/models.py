...
class PlagSamp(models.Model):
	plagfile1 = models.FileField(upload_to='plagfiles/', null=False, blank=False)
	plagfile2 = models.FileField(upload_to='plagfiles/', null=False, blank=False)
	...
	def __str__(self):
		return self.plagfile1.name + "_" + self.plagfile2.name
